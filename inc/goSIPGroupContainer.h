...
#ifndef GOSIPGROUPCONTAINER_H
#define GOSIPGROUPCONTAINER_H
...
*  
*/
class CgoSIPGroupContainer : public CCoeControl, MCoeControlObserver
    {
    ...
    public: // Functions from base classes
        ...
        */
        RPointerArray<CgoSIPUser> userArray;
